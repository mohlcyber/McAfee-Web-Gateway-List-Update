...
def get_list_id(headers, cookies):
    params = {'name': LIST}
...
def insert_list(headers, cookies, list_id, value):
    data = '''
...
if __name__ == "__main__":
    ...
    list_id = get_list_id(headers,cookies)

    insert = insert_list(headers, cookies, list_id, value)
